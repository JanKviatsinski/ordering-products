...
export const RegistrationFormCmp = ({onSubmitRegistration}) => {
    ...
    const prefixSelector = (
        <Form.Item name='prefix' noStyle>
            <FormSelectAnt>
                {prefixValues.map(prefix => <Option key={prefix} value={prefix}>{prefix}</Option>)}
            </FormSelectAnt>
        </Form.Item>
    );
    ...
    return (
        ...
        >
            ...
            <FormItemAnt
                name='phone'
            >
                <Input addonBefore={prefixSelector} placeholder='Phone number is optional'/>
            </FormItemAnt>

            <FormItemAnt
                name='telegram'
            >
                <Input placeholder='Enter the link to your telegram account! Is optional' />
            </FormItemAnt>
